 ...
 * 
 * @RunWith(SpringRunner.class) //@WebMvcTest(HomeController.class) public class
 * HomeControllerTest {
 * 
 * @Autowired private MockMvc mockMvc;
 * 
 * @Test public void testHomePage() throws Exception { mockMvc.perform(get("/"))
 * // Performs GET .andExpect(status().isOk()) // Expects HTTP 200
 * .andExpect(view().name("home")) // Expects home view
 * .andExpect(content().string(containsString("Welcome to..."))); // Expects
 * Welcome to... } }
 */