...
public interface Constants {
	...
	public static final String[] BARCODE_PRIVILEGES		= {VIEW_BARCODE_PRIVILEGE};
	...
	public static final String[][] PRIVILEGE_GROUPS = {HOME_PRIVILEGES, BARCODE_PRIVILEGES, ROLE_PRIVILEGES, USER_PRIVILEGES, AREA_PRIVILEGES, 
		EMPLOYEE_PRIVILEGES, VACANCY_PRIVILEGES, PROCESS_PRIVILEGES, PRODUCT_PRIVILEGES, HISTORIC_PRIVILEGES, PROFILE_PRIVILEGES, FINANCIAL_PRIVILEGES, 
		STATISTIC_PRIVILEGES, CONTROL_PRIVILEGES};
